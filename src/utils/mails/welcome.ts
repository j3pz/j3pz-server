...
export const welcome = ({
    title = '欢迎注册剑网3配装器',
    name, permalink, token,
}: WelcomeMailOptions): string => `
<!doctype html>
...
<![endif]--><div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
      ...
      <tr><td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'><div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:left;'>${name}侠士您好，感谢您注册<a href="https://www.j3pz.com">剑网3配装器</a>。在开始您的配装之旅前，还有以下几步需要完成。</div></td></tr>
    </table></div><!--[if mso | IE]>
</td></tr></table>
<![endif]--></td></tr></tbody></table></div><!--[if mso | IE]>
</td></tr></table>
